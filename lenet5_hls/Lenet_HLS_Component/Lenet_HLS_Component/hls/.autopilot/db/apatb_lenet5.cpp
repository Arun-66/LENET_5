...
// wrapc file define:
#define AUTOTB_TVIN_input_layer "../tv/cdatafile/c.lenet5.autotvin_input_layer.dat"
#define AUTOTB_TVOUT_input_layer "../tv/cdatafile/c.lenet5.autotvout_input_layer.dat"
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.lenet5.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.lenet5.autotvout_output_r.dat"
...
extern "C"
void lenet5_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_lenet5_hw(void* __xlx_apatb_param_input_layer, void* __xlx_apatb_param_output_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_input_layer),
#else
  ...
  port1.param = { __xlx_apatb_param_input_layer };
  port1.mname = { "input_layer" };
  port1.nbytes = { 4096 };
  ...
  try {
    ...
    lenet5_hw_stub_wrapper(__xlx_apatb_param_input_layer, __xlx_apatb_param_output_r);
