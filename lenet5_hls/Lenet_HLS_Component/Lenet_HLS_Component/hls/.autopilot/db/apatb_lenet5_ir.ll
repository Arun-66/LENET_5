; ModuleID = '/primary/Lenet_5/lenet5_hls/Lenet_HLS_Component/Lenet_HLS_Component/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_lenet5_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" %input_layer, float* noalias nocapture nonnull %output) local_unnamed_addr #0 {
entry:
  %0 = bitcast float* %input_layer to [1024 x float]*
  %1 = call i8* @malloc(i64 4096)
  %input_layer_copy = bitcast i8* %1 to [1024 x float]*
  %output_copy = alloca float, align 512
  call fastcc void @copy_in([1024 x float]* nonnull %0, [1024 x float]* %input_layer_copy, float* nonnull %output, float* nonnull align 512 %output_copy)
  call void @apatb_lenet5_hw([1024 x float]* %input_layer_copy, float* %output_copy)
  call void @copy_back([1024 x float]* %0, [1024 x float]* %input_layer_copy, float* %output, float* %output_copy)
  tail call void @free(i8* %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([1024 x float]* readonly, [1024 x float]*, float* readonly, float* align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([1024 x float]*, [1024 x float]* readonly, float*, float* readonly align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_lenet5_hw([1024 x float]*, float*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([1024 x float]*, [1024 x float]* readonly, float*, float* readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0f32(float* %2, float* align 512 %3)
  ret void
}

declare void @lenet5_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull)

define void @lenet5_hw_stub_wrapper([1024 x float]*, float*) #5 {
entry:
  call void @copy_out([1024 x float]* null, [1024 x float]* %0, float* null, float* %1)
  %2 = bitcast [1024 x float]* %0 to float*
  call void @lenet5_hw_stub(float* %2, float* %1)
  call void @copy_in([1024 x float]* null, [1024 x float]* %0, float* null, float* %1)
  ret void
}
