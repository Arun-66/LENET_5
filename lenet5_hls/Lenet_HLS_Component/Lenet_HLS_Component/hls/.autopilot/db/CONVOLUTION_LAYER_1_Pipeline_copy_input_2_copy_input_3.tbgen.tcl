set moduleName CONVOLUTION_LAYER_1_Pipeline_copy_input_2_copy_input_3
set isTopModule 0
...
set cdfgNum 7
set C_modelName {CONVOLUTION_LAYER_1_Pipeline_copy_input_2_copy_input_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict IBRAM { MEM_WIDTH 32 MEM_SIZE 4096 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	{ IBRAM float 32 regular {array 1024 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "IBRAM", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ IBRAM_we0 sc_out sc_logic 1 signal 0 } 
	{ IBRAM_d0 sc_out sc_lv 32 signal 0 } 
	{ input_layer_address0 sc_out sc_lv 10 signal 1 } 
	{ input_layer_ce0 sc_out sc_logic 1 signal 1 } 
	{ input_layer_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "IBRAM_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "IBRAM", "role": "we0" }} , 
 	{ "name": "IBRAM_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "IBRAM", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	IBRAM { ap_memory {  { IBRAM_address0 mem_address 1 10 }  { IBRAM_ce0 mem_ce 1 1 }  { IBRAM_we0 mem_we 1 1 }  { IBRAM_d0 mem_din 1 32 } } }
